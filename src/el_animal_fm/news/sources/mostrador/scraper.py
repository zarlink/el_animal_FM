...
def normalize_url(url: str) -> str:
    return discovery_module.normalize_url(url)


def is_elmostrador_article_url(url: str) -> bool:
    return discovery_module.is_elmostrador_article_url(url)
...
def discover_from_categoria_dia_range(
    ...
    return discovery_module.discover_from_categoria_dia_range(
        session=session,
        targets=targets,
        max_pages=max_pages,
    )
...
def discover_article_urls(
    ...
    return discovery_module.discover_article_urls(
        session=session,
        target=target,
